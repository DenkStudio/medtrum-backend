...
async function seedHealthcares(orgs: Awaited<ReturnType<typeof seedOrganizations>>) {
  const items = [
    { tradeName: 'OSDE', legalName: 'OSDE S.A.', cuit: '30-50004032-9', organizationId: orgs.mec.id },
    { tradeName: 'Swiss Medical', legalName: 'Swiss Medical S.A.', cuit: '30-63739649-0', organizationId: orgs.mec.id },
    { tradeName: 'Galeno', legalName: 'Galeno Argentina S.A.', cuit: '30-60411964-5', organizationId: orgs.intecmed.id },
    { tradeName: 'Medifé', legalName: 'Medifé Asociación Civil', cuit: '30-54653862-2', organizationId: orgs.intecmed.id },
  ];
  const created = [];
...
async function seedClaims(users: Record<string, any>) {
  ...
  const claimsData = [
    // ===== SENSOR (7 claims) =====
    { userId: patients[0].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'pending' as const, description: 'El sensor dejó de funcionar a los 3 días', needChange: true, lotNumber: 'LOT-S001', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_FALLA' as const, failureDate: daysAgo(6), colocationDate: daysAgo(9), createdAt: daysAgo(5) },
    { userId: patients[0].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'pending' as const, description: 'El adhesivo no pega correctamente', needChange: false, lotNumber: 'LOT-S002', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_FALTA_ADHESIVO' as const, failureDate: daysAgo(13), colocationDate: daysAgo(14), createdAt: daysAgo(12) },
    { userId: patients[1].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'pending' as const, description: 'Diferencia mayor a 40% con glucemia capilar', needChange: false, lotNumber: 'LOT-S003', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_DIFERENCIA_CAPILAR' as const, failureDate: daysAgo(9), colocationDate: daysAgo(12), createdAt: daysAgo(8) },
    { userId: patients[1].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'approved' as const, description: 'Sensor se perdió durante actividad deportiva', needChange: true, lotNumber: 'LOT-S004', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_PERDIDO' as const, failureDate: daysAgo(27), colocationDate: daysAgo(30), resolvedById: resolvers[0].id, resolvedAt: daysAgo(18), resolutionMessage: 'Se aprueba reposición del sensor', balanceAfterResolution: 20, createdAt: daysAgo(25) },
    { userId: patients[2].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'approved' as const, description: 'Error desconocido en lectura del sensor', needChange: false, lotNumber: 'LOT-S005', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_DESCONOCIDO' as const, failureDate: daysAgo(44), colocationDate: daysAgo(48), resolvedById: resolvers[0].id, resolvedAt: daysAgo(35), resolutionMessage: 'Aprobado, se repone sensor', balanceAfterResolution: 10, createdAt: daysAgo(42) },
    { userId: patients[2].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'rejected' as const, description: 'Sangrado leve en la colocación', needChange: false, lotNumber: 'LOT-S006', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_SANGRADO_COLOCACION' as const, failureDate: daysAgo(22), colocationDate: daysAgo(22), resolvedById: resolvers[2].id, resolvedAt: daysAgo(15), resolutionMessage: 'El sangrado leve no amerita reposición', createdAt: daysAgo(20) },
    { userId: patients[0].id, supply: 'SENSOR' as const, daysClaimed: 10, status: 'rejected' as const, description: 'Otro problema con el sensor', needChange: true, lotNumber: 'LOT-S007', claimCategory: 'SENSOR' as const, errorCode: 'SENSOR_OTROS' as const, failureDate: daysAgo(57), colocationDate: daysAgo(60), resolvedById: resolvers[0].id, resolvedAt: daysAgo(50), resolutionMessage: 'Descripción insuficiente para aprobar', createdAt: daysAgo(55) },

    // ===== PARCHE_200U (patients with 200u pump: 0,1,4) =====
    { userId: patients[0].id, supply: 'PARCHE_200U' as const, daysClaimed: 3, status: 'pending' as const, description: 'Parche no adhiere a la piel', needChange: true, lotNumber: 'LOT-P001', claimCategory: 'PARCHE_200U' as const, errorCode: 'PARCHE_FALTA_ADHESIVO' as const, failureDate: daysAgo(4), colocationDate: daysAgo(4), createdAt: daysAgo(3) },
    { userId: patients[4].id, supply: 'PARCHE_200U' as const, daysClaimed: 3, status: 'approved' as const, description: 'Batería se agotó antes de tiempo', needChange: false, lotNumber: 'LOT-P004', claimCategory: 'PARCHE_200U' as const, errorCode: 'PARCHE_BATERIA_AGOTADA' as const, failureDate: daysAgo(30), colocationDate: daysAgo(31), resolvedById: resolvers[1].id, resolvedAt: daysAgo(22), resolutionMessage: 'Aprobado, batería defectuosa confirmada', balanceAfterResolution: 24, createdAt: daysAgo(28) },
    { userId: patients[4].id, supply: 'PARCHE_200U' as const, daysClaimed: 3, status: 'approved' as const, description: 'Error durante el cebado', needChange: true, lotNumber: 'LOT-P005', claimCategory: 'PARCHE_200U' as const, errorCode: 'PARCHE_ERROR_CEBADO' as const, failureDate: daysAgo(47), colocationDate: daysAgo(48), resolvedById: resolvers[1].id, resolvedAt: daysAgo(40), resolutionMessage: 'Aprobado, error de cebado verificado', balanceAfterResolution: 21, createdAt: daysAgo(45) },
    { userId: patients[0].id, supply: 'PARCHE_200U' as const, daysClaimed: 3, status: 'rejected' as const, description: 'Parche se desactivó solo', needChange: false, lotNumber: 'LOT-P006', claimCategory: 'PARCHE_200U' as const, errorCode: 'PARCHE_DESACTIVADO' as const, failureDate: daysAgo(37), colocationDate: daysAgo(38), resolvedById: resolvers[0].id, resolvedAt: daysAgo(30), resolutionMessage: 'Desactivación fue por manipulación incorrecta', createdAt: daysAgo(35) },

    // ===== PARCHE_300U (patients with 300u pump: 2,3,5) =====
    { userId: patients[3].id, supply: 'PARCHE_300U' as const, daysClaimed: 3, status: 'pending' as const, description: 'Error en la pantalla del parche', needChange: false, lotNumber: 'LOT-P002', claimCategory: 'PARCHE_300U' as const, errorCode: 'PARCHE_ERROR' as const, failureDate: daysAgo(7), colocationDate: daysAgo(8), createdAt: daysAgo(6) },
    { userId: patients[3].id, supply: 'PARCHE_300U' as const, daysClaimed: 3, status: 'pending' as const, description: 'Obstrucción en la cánula', needChange: true, lotNumber: 'LOT-P003', claimCategory: 'PARCHE_300U' as const, errorCode: 'PARCHE_OBSTRUCCION' as const, failureDate: daysAgo(16), colocationDate: daysAgo(17), createdAt: daysAgo(15) },
    { userId: patients[3].id, supply: 'PARCHE_300U' as const, daysClaimed: 3, status: 'rejected' as const, description: 'Otro problema con el parche', needChange: false, lotNumber: 'LOT-P007', claimCategory: 'PARCHE_300U' as const, errorCode: 'PARCHE_OTROS' as const, failureDate: daysAgo(15), colocationDate: daysAgo(16), resolvedById: resolvers[1].id, resolvedAt: daysAgo(10), resolutionMessage: 'No se pudo reproducir el problema', createdAt: daysAgo(14) },

    // ===== TRANSMISOR (5 claims) =====
    { userId: patients[1].id, supply: 'TRANSMISOR' as const, daysClaimed: 0, status: 'pending' as const, description: 'Conectores del transmisor están oxidados', needChange: true, lotNumber: 'LOT-T001', claimCategory: 'TRANSMISOR' as const, errorCode: 'TRANSMISOR_CONECTORES_OXIDADOS' as const, createdAt: daysAgo(4) },
    { userId: patients[3].id, supply: 'TRANSMISOR' as const, daysClaimed: 0, status: 'pending' as const, description: 'La luz verde no parpadea al conectar', needChange: true, lotNumber: 'LOT-T002', claimCategory: 'TRANSMISOR' as const, errorCode: 'TRANSMISOR_LUZ_VERDE_NO_PARPADEA' as const, createdAt: daysAgo(9) },
    { userId: patients[1].id, supply: 'TRANSMISOR' as const, daysClaimed: 0, status: 'approved' as const, description: 'Problemas con la batería del transmisor', needChange: false, lotNumber: 'LOT-T003', claimCategory: 'TRANSMISOR' as const, errorCode: 'TRANSMISOR_PROBLEMAS_BATERIA' as const, resolvedById: resolvers[0].id, resolvedAt: daysAgo(48), resolutionMessage: 'Aprobado, se envía transmisor de reemplazo', createdAt: daysAgo(55) },
    { userId: patients[3].id, supply: 'TRANSMISOR' as const, daysClaimed: 0, status: 'approved' as const, description: 'Transmisor roto por caída', needChange: true, lotNumber: 'LOT-T004', claimCategory: 'TRANSMISOR' as const, errorCode: 'TRANSMISOR_ROTURA' as const, resolvedById: resolvers[1].id, resolvedAt: daysAgo(25), resolutionMessage: 'Aprobado, rotura confirmada por fotos', createdAt: daysAgo(30) },
    { userId: patients[1].id, supply: 'TRANSMISOR' as const, daysClaimed: 0, status: 'rejected' as const, description: 'Otro problema con el transmisor', needChange: false, lotNumber: 'LOT-T005', claimCategory: 'TRANSMISOR' as const, errorCode: 'TRANSMISOR_OTROS' as const, resolvedById: resolvers[0].id, resolvedAt: daysAgo(60), resolutionMessage: 'Se requiere más información para evaluar', createdAt: daysAgo(65) },

    // ===== BASE_BOMBA_200U (patients with 200u: 0,1,4) =====
    { userId: patients[4].id, supply: 'BASE_BOMBA_200U' as const, daysClaimed: 0, status: 'pending' as const, description: 'La base no encastra en el parche', needChange: true, lotNumber: 'LOT-BB002', claimCategory: 'BASE_BOMBA_200U' as const, errorCode: 'BASE_BOMBA_NO_ENCASTRA' as const, createdAt: daysAgo(11) },
    { userId: patients[4].id, supply: 'BASE_BOMBA_200U' as const, daysClaimed: 0, status: 'approved' as const, description: 'Rotura de la base bomba', needChange: true, lotNumber: 'LOT-BB004', claimCategory: 'BASE_BOMBA_200U' as const, errorCode: 'BASE_BOMBA_ROTURA' as const, resolvedById: resolvers[1].id, resolvedAt: daysAgo(32), resolutionMessage: 'Aprobado, se envía reemplazo', createdAt: daysAgo(38) },

    // ===== BASE_BOMBA_300U (patients with 300u: 2,3,5) =====
    { userId: patients[2].id, supply: 'BASE_BOMBA_300U' as const, daysClaimed: 0, status: 'pending' as const, description: 'Conectores de la base bomba oxidados', needChange: true, lotNumber: 'LOT-BB001', claimCategory: 'BASE_BOMBA_300U' as const, errorCode: 'BASE_BOMBA_CONECTORES_OXIDADOS' as const, createdAt: daysAgo(7) },
    { userId: patients[2].id, supply: 'BASE_BOMBA_300U' as const, daysClaimed: 0, status: 'approved' as const, description: 'La base bomba no emite pitidos', needChange: false, lotNumber: 'LOT-BB003', claimCategory: 'BASE_BOMBA_300U' as const, errorCode: 'BASE_BOMBA_NO_HACE_PITIDOS' as const, resolvedById: resolvers[0].id, resolvedAt: daysAgo(52), resolutionMessage: 'Aprobado, falla de altavoz confirmada', createdAt: daysAgo(58) },
    { userId: patients[2].id, supply: 'BASE_BOMBA_300U' as const, daysClaimed: 0, status: 'rejected' as const, description: 'Otro problema con la base bomba', needChange: false, lotNumber: 'LOT-BB005', claimCategory: 'BASE_BOMBA_300U' as const, errorCode: 'BASE_BOMBA_OTROS' as const, resolvedById: resolvers[2].id, resolvedAt: daysAgo(20), resolutionMessage: 'Problema no reproducible', createdAt: daysAgo(24) },

    // ===== CABLE_TRANSMISOR (3 claims) =====
    { userId: patients[0].id, supply: 'CABLE_TRANSMISOR' as const, daysClaimed: 0, status: 'pending' as const, description: 'El cable no carga el transmisor', needChange: true, lotNumber: 'LOT-CT001', claimCategory: 'CABLE_TRANSMISOR' as const, errorCode: 'CABLE_NO_CARGA' as const, createdAt: daysAgo(2) },
    { userId: patients[5].id, supply: 'CABLE_TRANSMISOR' as const, daysClaimed: 0, status: 'approved' as const, description: 'Pin del cable doblado', needChange: true, lotNumber: 'LOT-CT002', claimCategory: 'CABLE_TRANSMISOR' as const, errorCode: 'CABLE_PIN_DOBLADO' as const, resolvedById: resolvers[1].id, resolvedAt: daysAgo(36), resolutionMessage: 'Aprobado, pin doblado visible en foto', createdAt: daysAgo(42) },
    { userId: patients[5].id, supply: 'CABLE_TRANSMISOR' as const, daysClaimed: 0, status: 'rejected' as const, description: 'Otro problema con el cable', needChange: false, lotNumber: 'LOT-CT003', claimCategory: 'CABLE_TRANSMISOR' as const, errorCode: 'CABLE_OTROS' as const, resolvedById: resolvers[1].id, resolvedAt: daysAgo(8), resolutionMessage: 'Cable funciona correctamente según pruebas', createdAt: daysAgo(13) },

    // ===== PDM (5 claims) =====
    { userId: patients[1].id, supply: 'PDM' as const, daysClaimed: 0, status: 'pending' as const, description: 'PDM no carga ni enciende', needChange: true, lotNumber: 'LOT-PDM001', claimCategory: 'PDM' as const, errorCode: 'PDM_NO_CARGA_NO_ENCIENDE' as const, createdAt: daysAgo(6) },
    { userId: patients[5].id, supply: 'PDM' as const, daysClaimed: 0, status: 'pending' as const, description: 'PDM se apaga solo constantemente', needChange: true, lotNumber: 'LOT-PDM002', claimCategory: 'PDM' as const, errorCode: 'PDM_SE_APAGA_SOLO' as const, createdAt: daysAgo(10) },
    { userId: patients[1].id, supply: 'PDM' as const, daysClaimed: 0, status: 'approved' as const, description: 'PDM no carga la batería', needChange: false, lotNumber: 'LOT-PDM003', claimCategory: 'PDM' as const, errorCode: 'PDM_NO_CARGA' as const, resolvedById: resolvers[0].id, resolvedAt: daysAgo(44), resolutionMessage: 'Aprobado, falla de carga confirmada', createdAt: daysAgo(50) },
    { userId: patients[5].id, supply: 'PDM' as const, daysClaimed: 0, status: 'approved' as const, description: 'PDM con pantalla rota', needChange: true, lotNumber: 'LOT-PDM004', claimCategory: 'PDM' as const, errorCode: 'PDM_ROTURA' as const, resolvedById: resolvers[1].id, resolvedAt: daysAgo(18), resolutionMessage: 'Aprobado, rotura evidente', createdAt: daysAgo(23) },
    { userId: patients[1].id, supply: 'PDM' as const, daysClaimed: 0, status: 'rejected' as const, description: 'Otro problema con PDM', needChange: false, lotNumber: 'LOT-PDM005', claimCategory: 'PDM' as const, errorCode: 'PDM_OTROS' as const, resolvedById: resolvers[0].id, resolvedAt: daysAgo(14), resolutionMessage: 'Problema no identificable, se solicita revisión presencial', createdAt: daysAgo(19) },
  ];
