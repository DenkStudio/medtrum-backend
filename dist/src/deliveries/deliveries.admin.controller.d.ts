...
export declare class DeliveriesAdminController {
    private readonly service;
    constructor(service: DeliveriesAdminService);
    create(dto: CreateDeliveryDto, user: AuthUser): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
...
//# sourceMappingURL=deliveries.admin.controller.d.ts.map