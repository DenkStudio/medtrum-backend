...
const doctors_admin_controller_1 = require("./doctors.admin.controller");
let DoctorsModule = class DoctorsModule {
};
exports.DoctorsModule = DoctorsModule;
exports.DoctorsModule = DoctorsModule = __decorate([
    (0, common_1.Module)({
        providers: [doctors_admin_service_1.DoctorsAdminService],
        controllers: [doctors_admin_controller_1.DoctorsAdminController],
        exports: [doctors_admin_service_1.DoctorsAdminService],
    })
], DoctorsModule);
