...
export declare class AdminsAdminService {
    private prisma;
    private supabase;
    private config;
    constructor(prisma: PrismaService, supabase: SupabaseService, config: ConfigService);
...
//# sourceMappingURL=admins.admin.service.d.ts.map