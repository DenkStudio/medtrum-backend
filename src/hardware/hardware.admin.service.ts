...
export class HardwareAdminService {
  ...
  async getErrorsByProduct(user: AuthUser, organizationId?: string, startDate?: string, endDate?: string) {
    ...
    const errorLabelMap: Record<string, string> = {
      // Sensor
      SENSOR_FALLA: "Error de sensor",
      SENSOR_FALTA_ADHESIVO: "Sin adhesivo",
      SENSOR_DIFERENCIA_CAPILAR: "Diferencia capilar",
      SENSOR_PERDIDO: "Perdido",
      SENSOR_DESCONOCIDO: "???",
      SENSOR_SANGRADO_COLOCACION: "Sangrado colocación",
      SENSOR_SIN_LECTURA: "Sin lectura",
      SENSOR_FALLO: "Fallo",
      SENSOR_PERDIDA_SENAL: "Pérdida de señal",
      SENSOR_CAMBIO_DISPOSITIVO: "Cambio de dispositivo",
      SENSOR_OTROS: "Otros",
      // Parche
      PARCHE_FALTA_ADHESIVO: "Sin adhesivo",
      PARCHE_ERROR: "Error de parche",
      PARCHE_OBSTRUCCION: "Oclusión",
      PARCHE_BATERIA_AGOTADA: "Batería agotada",
      PARCHE_ERROR_CEBADO: "No pasa a cebar",
      PARCHE_DESACTIVADO: "Desactivado",
      PARCHE_NO_HACE_PITIDOS: "No hace pitidos",
      PARCHE_NO_ENCASTRA_BASE: "No encastra a la base",
      PARCHE_CAMBIO_DISPOSITIVO: "Cambio de dispositivo",
      PARCHE_OTROS: "Otros",
      // Transmisor
      TRANSMISOR_CONECTORES_OXIDADOS: "Conectores oxidados",
      TRANSMISOR_LUZ_VERDE_NO_PARPADEA: "Luz verde no parpadea",
      TRANSMISOR_PROBLEMAS_BATERIA: "Batería agotada",
      TRANSMISOR_ROTURA: "Rotura",
      TRANSMISOR_NO_CUBRE_DIAS: "No cubre los días",
      TRANSMISOR_NO_ENCIENDE_LUZ: "No enciende la luz",
      TRANSMISOR_DIFERENCIA_CAPILAR: "Diferencia capilar",
      ...
      BASE_BOMBA_NO_PASA_CEBAR: "No pasa a cebar",
      BASE_BOMBA_ERROR: "Error base de bomba",
      BASE_BOMBA_MULTIPLES_OCLUSION: "Múltiples oclusión",
      BASE_BOMBA_MULTIPLES_DESCONEXION: "Múltiples desconexión",
      ...
      PDM_ROTURA: "Rotura",
      PDM_DESCONEXION_BOMBA: "Desconexión de bomba",
      PDM_OTROS: "Otros",
    };
